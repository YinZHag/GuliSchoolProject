...
public class EduCourseServiceImpl extends ServiceImpl<EduCourseMapper, EduCourse> implements EduCourseService {
    ...
    //删除课程 根据课程id删除课程，章节，小节以及课程描述相关的知识和视频
    @Override
    ...
    //查询前八条热门课程
    @Cacheable(value = "course",key = "'courseList'") //todo 如果Redis数据库查询没有结果，则先查询mysql数据库，然后加入redis缓存中
    @Override
    public List<EduCourse> selectHotCourse() {
        ...
        List<EduCourse> list = baseMapper.selectList(queryWrapperCourse);
        return list;
    }
    ...
    //2 根据课程id，编写sql语句查询课程信息 课程详情的方法
    @Override
